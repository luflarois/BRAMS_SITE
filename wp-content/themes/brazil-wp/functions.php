...
/** 
* Function used to define user global variables
**/
function user_global_variables() {
  global $ftp_url; 
  $ftp_url="http://ftp.cptec.inpe.br/pesquisa/bramsrd/BRAMS_5.4/";
}
add_action( 'parse_query', 'user_global_variables' );
