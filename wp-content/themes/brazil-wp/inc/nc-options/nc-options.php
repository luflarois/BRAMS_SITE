...
function setup_framework_options() {
    ...
    $sections[] = array(
        ...
        'fields' => array(
          /*
             array(
                'id' => 'webnus_oneclick_importer_all',
                'title' => __('Click to import all pages and posts demo data', WEBNUS_TEXT_DOMAIN),
				'type' => 'oneclick',
                'std' => '1'
            ),
             array(
                'id' => 'webnus_oneclick_importer_page',
                'title' => __('Click to import pages demo data', WEBNUS_TEXT_DOMAIN),
				'type' => 'oneclick',
                'std' => '1'
            ),
            
             array(
                'id' => 'webnus_oneclick_importer_templatera',
                'title' => __('Click to import Templatera demo data', WEBNUS_TEXT_DOMAIN),
				'type' => 'oneclick',
				'desc'=>'<a href="http://webnus.biz/brazil/dox/#templatera">Click here to learn more about Templatera</a>',
                'std' => '1'
            ),			
			
            
             array(
                'id' => 'webnus_oneclick_setup_reading',
                'title' => __('Click to setup default fronepage and blog', WEBNUS_TEXT_DOMAIN),
				'type' => 'oneclick',
				'desc'=>'Click this button to setup predefined values to wordpress Reading Setting such as Fronepage and Blog page<br/>
						Note that you should import demo pages before click this button.',
                'std' => '1'
            ),			
			*/
            array(
           ...
           array(
                ...
                'type' => 'button_set',
                'title' => __('Show/Hide breadcrumbs', WEBNUS_TEXT_DOMAIN),
    ...
    $sections[] = array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'desc' => __('Set width to logo', WEBNUS_TEXT_DOMAIN),
                'std' => '120'
            ),
            ...
            array(
                ...
                'desc'=>__('enter your desired amount (by pixel) which by scrolling that amount, sticky menu will appear in page.',WEBNUS_TEXT_DOMAIN),
                'value' => '150',
            ),            
			  array(
                ...
                'options' => array(0 => __('None',WEBNUS_TEXT_DOMAIN), 1 => __('Search Box',WEBNUS_TEXT_DOMAIN), 2 => __('Contact Information',WEBNUS_TEXT_DOMAIN), 3 => __('Advertisement Widget',WEBNUS_TEXT_DOMAIN)),
                'std' => '1'
            ),
            array(
                ...
                'options' => array(
                	'1' => array('title' => __('Menu Layout 1', WEBNUS_TEXT_DOMAIN), 'img' => $theme_img_dir . 'menutype/menu1.png'),
                    '4' => array('title' => __('Menu Layout 2', WEBNUS_TEXT_DOMAIN), 'img' => $theme_img_dir . 'menutype/menu2.png'),
                    '5' => array('title' => __('Menu Layout 3', WEBNUS_TEXT_DOMAIN), 'img' => $theme_img_dir . 'menutype/menu3.png'),
                    '2' => array('title' => __('Menu Layout 4', WEBNUS_TEXT_DOMAIN), 'img' => $theme_img_dir . 'menutype/menu4.png'),
                    '3' => array('title' => __('Menu Layout 5', WEBNUS_TEXT_DOMAIN), 'img' => $theme_img_dir . 'menutype/menu5.png'),
 			...
 			array(
                ...
                'type' => 'button_set',
                'title' => __('Enable/Disable Search in Menu Type 1', WEBNUS_TEXT_DOMAIN),
                'options' => array('0' => __('Disable', WEBNUS_TEXT_DOMAIN), '1' => __('Enable', WEBNUS_TEXT_DOMAIN)),
                'std' => '0'
            ),
			  ...
			  array(
               ...
               'options' => array(
               		'sm-rgt-ms' => array('title' => __('Right side', WEBNUS_TEXT_DOMAIN), 'img' => $theme_img_dir . 'menutype/menu-icon1.png'),
               		'' => array('title' => __('Center', WEBNUS_TEXT_DOMAIN), 'img' => $theme_img_dir . 'menutype/menu-icon2.png'),
                ),
            ...
            // array(
                // 'id' => 'webnus_header_color_type',
                // 'type' => 'button_set',
                // 'title' => __('Header color type', WEBNUS_TEXT_DOMAIN),
                // 'options' => array('' => __('Light', WEBNUS_TEXT_DOMAIN), 'dark' => __('Dark', WEBNUS_TEXT_DOMAIN)),
                // 'std' => ''
            // ),            
            // array(
                // 'id' => 'webnus_logo_dark',
                // 'type' => 'upload',
                // 'title' => __('Logo for Dark header', WEBNUS_TEXT_DOMAIN),
                // 'desc' => __('Please choose an image file for your logo.<br/> For Retina displays please add Image in large size and set custom width.', WEBNUS_TEXT_DOMAIN),
            // ),
			 // array(
                // 'id' => 'webnus_logo_width_dark',
                // 'type' => 'text',
                // 'title' => __('Logo Width for dark header', WEBNUS_TEXT_DOMAIN),
                // 'std' => '120'
            // ),	
    ...
    $sections[] = array(
        ...
        array(
                ...
                'options' => array('1' => array('title' => __('Teal&nbsp;&nbsp;&nbsp;', WEBNUS_TEXT_DOMAIN), 'img' => NHP_OPTIONS_URL . 'img/color3-ss.png')
                ,'2' => array('title' => __('Blue&nbsp;&nbsp;&nbsp;&nbsp;', WEBNUS_TEXT_DOMAIN), 'img' => NHP_OPTIONS_URL . 'img/color1-ss.png')
                ,'3' => array('title' => __('Red&nbsp;&nbsp;', WEBNUS_TEXT_DOMAIN), 'img' => NHP_OPTIONS_URL . 'img/color4-ss.png')
                ,'4' => array('title' => __('Yellow&nbsp;&nbsp;', WEBNUS_TEXT_DOMAIN), 'img' => NHP_OPTIONS_URL . 'img/color2-ss.png')
	            , '5' => array('title' => __('Pink&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', WEBNUS_TEXT_DOMAIN), 'img' => NHP_OPTIONS_URL . 'img/color5-ss.png')
	            , '6' => array('title' => __('Green', WEBNUS_TEXT_DOMAIN), 'img' => NHP_OPTIONS_URL . 'img/color6-ss.png')
	            , '7' => array('title' => __('Orchid', WEBNUS_TEXT_DOMAIN), 'img' => NHP_OPTIONS_URL . 'img/color7-ss.png')
	            , '8' => array('title' => __('Jade&nbsp;', WEBNUS_TEXT_DOMAIN), 'img' => NHP_OPTIONS_URL . 'img/color8-ss.png')
	            , '9' => array('title' => __('SkyBlue', WEBNUS_TEXT_DOMAIN), 'img' => NHP_OPTIONS_URL . 'img/color9-ss.png')
	            , '10' => array('title' => __('Orange', WEBNUS_TEXT_DOMAIN), 'img' => NHP_OPTIONS_URL . 'img/color10-ss.png')
                ),
    ...
    $sections[] = array(
        ...
        'fields' => array(
            ...
            array(
                'id' => 'webnus_allow_comments_on_blog',
                'type' => 'checkbox',
                'title' => __('Allow Comments On Blog Post', WEBNUS_TEXT_DOMAIN),
                'desc' => __('Allow comments on blog post.', WEBNUS_TEXT_DOMAIN),
                'std' => '1'
            ),
