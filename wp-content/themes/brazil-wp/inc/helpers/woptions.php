...
if (!class_exists('webnus_options')) {
	...
	class webnus_options {
		...
		function webnus_enable_responsive() {
			...
			return isset($thm_options['webnus_enable_responsive']) ? $thm_options['webnus_enable_responsive'] : null;
		...
		function webnus_allow_comments_on_blog() {
			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_allow_comments_on_blog']) ? $thm_options['webnus_allow_comments_on_blog'] : null;
		}
		...
		function webnus_get_google_fonts() {
			...
			if (count($fonts_array) > 0) {
  				$fonts_array = array_diff($fonts_array, array('custom-font-1','custom-font-2','custom-font-3'));					
