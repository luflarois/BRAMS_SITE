...
class WebnusSocialWidget extends WP_Widget{
	...
	public function form($instance){
		...
		<p>
		<label for="<?php echo $this->get_field_id('picassa_link') ?>">Picassa URL:</label>
		<input type="text"		
		class="widefat"
		...
		if( empty($picassa_link ) ) echo $picassa ; else echo esc_attr(!empty($picassa_link)?$picassa_link:''); 
		?>" />
		</p>
	...
	public function widget($args, $instance){
		...
		?>
			...
			<?php
				...
				if(!empty($picassa_link)) echo '<a href="'. $picassa_link .'" class="other-social"><i class="fa-share-alt"></i></a>';
