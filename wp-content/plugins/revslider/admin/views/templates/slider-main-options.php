							...
							<div id="fullscreen-advanced-sizing">
								<span class="one-half-container" style="vertical-align:top">
									...
									<span style="text-align:left; padding:0px 20px;">
										...
										<input type="checkbox"  class="tp-moderncheckbox withlabel" id="autowidth_force" name="autowidth_force" data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'full_screen_align_force', 'off'), "on");?>>
